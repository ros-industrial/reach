...
template <>
const std::string PluginTest<reach::plugins::EvaluationBase>::base_class_name =
    EVAL_PLUGIN_BASE;
...
template <>
const std::string PluginTest<reach::plugins::IKSolverBase>::base_class_name =
    IK_PLUGIN_BASE;
...
template <>
const std::string PluginTest<reach::plugins::DisplayBase>::base_class_name =
    DISPLAY_PLUGIN_BASE;
...
using Implementations =
    ::testing::Types<reach::plugins::EvaluationBase,
                     reach::plugins::IKSolverBase, reach::plugins::DisplayBase>;
...
TYPED_TEST(PluginTest, LoadPlugins) {
  ...
  // Expect the number of declared classes of this type to equal the amount in
  // the map
