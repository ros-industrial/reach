...
namespace reach
{
  ...
  namespace plugins
  {
    ...
    public:
      ...
      virtual void showEnvironment(const std::vector<std::string> & names, const std::vector<double>& positions) = 0;
      ...
      void compareDatabases(const std::map<std::string, reach_msgs::msg::ReachDatabase> &data)
      {
