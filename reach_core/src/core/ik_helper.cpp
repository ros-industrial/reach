...
namespace reach
{
  namespace core
  {
    ...
    std::vector<reach_msgs::msg::ReachRecord> getNeighbors(const reach_msgs::msg::ReachRecord &rec,
    ...
    std::vector<reach_msgs::msg::ReachRecord> getNeighborsFLANN(const reach_msgs::msg::ReachRecord &rec,
                                                                const ReachDatabasePtr db,
                                                                const double radius,
                                                                SearchTreePtr search_tree)
    {
      ...
      search_tree->radiusSearch(query, indices, distances, radius, flann::SearchParams());
